...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-[#E6F3F3] to-[#F7FAFC] relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1507608869274-d3177c8bb4c7')] opacity-100 bg-cover bg-center" />
      <div className="absolute inset-0 bg-white/20 backdrop-blur-[1px]" />

      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10 backdrop-blur-sm p-6 rounded-xl">
        <div className="order-2 lg:order-1 animate-fade-in">
          <div className="space-y-6 max-w-lg mx-auto lg:mx-0 backdrop-blur-sm p-6 rounded-xl">
            <div className="flex items-center mb-8">
              <img src="/logo-03.png" alt="Ekaant" className="h-24 w-auto rounded-full shadow-xl" />
            </div>
            <h2 className="text-[25px] text-[#333333] font-bold mb-6">
              Your Mental Health
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                Matters to Us
              </span>
        ...
        <div className="order-1 lg:order-2 animate-fade-in">
          <div className="bg-white/40 backdrop-blur-md p-8 rounded-xl border border-white/20 shadow-lg">
            <div className="flex justify-between mb-8">
              <Link to="/sign-in" className="text-base font-medium px-4 py-2 rounded bg-gray-100 text-gray-900">
                Sign In
              </Link>
              <Link to="/sign-up" className="text-base font-medium px-4 py-2 rounded text-gray-500">
                Sign Up
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-[#1E1B4B] text-white py-3 rounded-lg hover:bg-[#1E1B4B]/90 transition duration-200 flex justify-center items-center"
                disabled={loading}
              >
                {loading ? (
                  <>
      ...
      <footer className="absolute bottom-8 left-8 flex items-center justify-center w-full">
        <p className="text-gray-500 flex items-center justify-center">
          © {new Date().getFullYear()} Ekaant. All rights reserved.
        </p>
      </footer>
    </div>
  );
