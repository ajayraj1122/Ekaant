...
//         if (!barChartData[currentMonth]) {
//           barChartData[currentMonth] = { Program: 0, LiveSessions: 0, Experts: 0, Challenge: 0 };
//         }
        
//         barChartData[currentMonth].Challenge += 1;
...
//         // Update bar chart data immediately
//         const currentMonth = new Date().toLocaleString('default', { month: 'short' });
//         const barChartData = JSON.parse(localStorage.getItem("barChartData") || "{}");
...
//         // Force chart update
//         window.dispatchEvent(new Event('chartDataUpdated'));
//         window.dispatchEvent(new Event('expertBookingUpdated'));
