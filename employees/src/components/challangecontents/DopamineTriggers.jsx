...
export default function DopamineTrigger() {
  ...
  useEffect(() => {
    const fetchProgress = async () => {
      try {
        ...
        const response = await fetch('https://ekaant.onrender.com/api/challengeprogresstracking?challengeType=dopamineTrigger', {
          headers: {
